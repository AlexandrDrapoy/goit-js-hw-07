...
// Створи галерею з можливістю кліку по її елементах і перегляду повнорозмірного зображення у модальному
// вікні.Подивися демо відео роботи галереї.
...
//     і вказуватися в href посилання.Не додавай інші HTML теги або CSS класи,
...
function onClickShowOriginalImg(evt) {
  ...
  const instance = basicLightbox.create(`
    <img src='${evt.target.dataset.source}' name = "img" width="800" height="600">
`);

  instance.show(() => document.addEventListener("keydown", onCloseModal));
